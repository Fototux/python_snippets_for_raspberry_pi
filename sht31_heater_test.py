...
print ("enable heater")
# enable heater
msg = i2c_msg.write(DEVICE_ADDR, [0x30, 0x6D])
bus.i2c_rdwr(msg)
...
msg = i2c_msg.write(DEVICE_ADDR, [0xF3, 0x2D])
bus.i2c_rdwr(msg)
# read 2 bytes
msg = i2c_msg.read(DEVICE_ADDR, 6)
bus.i2c_rdwr(msg)

print (bin(msg.buf[0][0]<<8 | msg.buf[1][0])) 

print ("perform soft reset")
# soft reset
msg = i2c_msg.write(DEVICE_ADDR, [0x30, 0xA2])
bus.i2c_rdwr(msg)

# wait > 1.5 ms to allow sensor to enter idle state again
time.sleep(1)
...
# disable heater
msg = i2c_msg.write(DEVICE_ADDR, [0x30, 0x66])
bus.i2c_rdwr(msg)
