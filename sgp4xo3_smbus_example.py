...
for _ in range(10):
    ...
    msg = i2c_msg.write(DEVICE_ADDR, [0x26, 0x0F])
    bus.i2c_rdwr(msg)

    # wait for measurement
    time.sleep(1)

    # read 3 by 3 bytes; each triple consists of MSB, LSB, CRC;
    msg = i2c_msg.read(DEVICE_ADDR, 9)
    bus.i2c_rdwr(msg)

    # merge byte 0 and byte 1 to int16_t
    o3 = msg.buf[3][0]<<8 | msg.buf[4][0]

    print(("{0:.1f}").format(o3))
